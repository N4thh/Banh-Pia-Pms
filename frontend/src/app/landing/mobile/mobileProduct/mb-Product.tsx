...
export default function MobileProduct({ onCartUpdate }: ProductProps) {
    const [openSaurieng, setOpenSaurieng] = useState(false);

    return(
        <div className="flex flex-col max-h-70vh gap-4 sm:gap-6 md:gap-8 px-2 sm:px-4">
            <div className="flex flex-col items-center justify-center">
                ...
                <div className="flex flex-wrap justify-center w-full max-w-full gap-2 sm:gap-3 md:gap-4 pt-[1vh] px-2">
                    ...
                    <div className="flex gap-2">
                        <div className="border border-amber-50 rounded-3xl inline-flex items-center justify-center
                            py-2 sm:py-1.5 px-4 sm:px-4 md:px-7
                            font-semibold text-[clamp(11px,0.9vw,20.25px)] text-[#FDF6E8] whitespace-nowrap"
                        > BÙI</div>
                        <div className="border border-amber-50 rounded-3xl inline-flex items-center justify-center
                            py-2 sm:py-1.5 px-4 sm:px-4 md:px-6
            ...
            {/* Product */}
            <div className="flex flex-col md:flex-row flex-1 w-full gap-3 sm:gap-5 md:gap-10 min-h-0 sm:pt-[2vh] mt-12">
                <button
                    type="button"
                ...
                >
                    ...
                    {/* Product */}
                    <div className=" w-3/5 sm:w-1/2 flex flex-col items-start justify-start p-2 sm:p-3 md:p-4 min-w-0 h-50">
                        <h1 className="font-vollkorn font-semibold text-[#3D2008] text-xl leading-tight">
                            Nhân Sầu Riêng
                        </h1>

                        <h2 className="text-[#C2973F] text-base leading-snug mt-1">
