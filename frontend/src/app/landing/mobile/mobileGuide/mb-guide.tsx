        ...
        <div className="flex flex-col w-full min-h-full gap-4 sm:gap-12 md:gap-14 px-2 sm:px-4">
            <div className="flex flex-col items-center justify-center">
                ...
                <div className="flex flex-wrap justify-center w-full max-w-full gap-4 pt-[1vh] px-2 mt-1 ">
                    ...
                    <div className="border border-amber-50 rounded-3xl inline-flex items-center justify-center
                        py-1  px-2 sm:px-1 md:px-1
                        font-semibold text-xs text-[#FDF6E8] whitespace-nowrap"
            ...
            >
                ...
                <div className="w-full h-[20vh]">
                   <div className="border h-full w-full bg-gray-300 rounded-2xl">
